...
conda create -n ss-fha python=3.11
...
```bash
# With conda
conda env export -n ss-fha > environment-lock.yaml
...
RUN echo "conda activate ss-fha" >> ~/.bashrc
```
