...
Report bugs at https://github.com/lassiterdc/ss_fha/issues.
...
ss-fha could always use more documentation, whether as part of the official docs, in docstrings, or even on the web in blog posts, articles, and such.
...
The best way to send feedback is to file an issue at https://github.com/lassiterdc/ss_fha/issues.
...
Ready to contribute? Here's how to set up `ss_fha` for local development.

1. Fork the `ss_fha` repo on GitHub.
2. Clone your fork locally:

   ```sh
   git clone git@github.com:your_name_here/ss_fha.git
   ```
