...
fname_out = model_results / "triton_only_ensemble.zarr"
...
fname_out = model_results / "tritonswmm_ensemble_rain_only.zarr"
# tsut.write_zarr(ds, fname_out, compression_level=5)
encoding = return_dic_zarr_encodings_v2(ds)
ds.to_zarr(fname_out, mode="w", encoding=encoding, consolidated=False, zarr_format=2)
...
fname_out = model_results / "tritonswmm_ensemble_surge_only.zarr"
# tsut.write_zarr(ds, fname_out, compression_level=5)
encoding = return_dic_zarr_encodings_v2(ds)
ds.to_zarr(fname_out, mode="w", encoding=encoding, consolidated=False, zarr_format=2)
...
fname_out = model_results / "tritonswmm_ensemble.zarr"
# tsut.write_zarr(ds, fname_out, compression_level=5)
encoding = return_dic_zarr_encodings_v2(ds)
ds.to_zarr(fname_out, mode="w", encoding=encoding, consolidated=False, zarr_format=2)
...
f_out = model_results / f"design_storm_tritonswmm_{scen_type}.zarr"
encoding = return_dic_zarr_encodings_v2(ds)
...
f_out = weather / f"design_storm_{scen_type}.nc"
ds.to_netcdf(f_out)
